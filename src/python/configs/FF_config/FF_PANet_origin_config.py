...
_CN.PANet_ckpt = r"/home/haibo/FF_CompenUltra_lab/checkpoint/FF_PANet/SL_PANet_final.pth"
# latentcostformer
...
_CN.trainer.comp_scheduler.step_size = 800  # Used only when type is 'step_lr' #32000
_CN.trainer.comp_scheduler.gamma = 0.5
