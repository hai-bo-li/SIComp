...
_CN.batch_size = 1
_CN.train_loss = 'l1+ssim+lpips'
_CN.name = "SIComp(#surf=5 L1+SSIM+LPIPS)"
_CN.model_name = "SIComp(#surf=5 L1+SSIM+LPIPS)"
_CN.num_train = 500
_CN.surf_indices = [0, 31, 62, 93, 124]
_CN.OmniCompNet_pretrian_path = r"../../checkpoint/SIComp/SIComp_surf5_l1_ssim_lpips/step_12000_final.pth"
# latentcostformer
