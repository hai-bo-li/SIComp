...
_CN = CN()
_CN.name = "FF+PANet"
_CN.model_name = "FF+PANet"
_CN.train_loss = 'l1+l2+ssim'
_CN.num_train = 500
_CN.transformer = 'latentcostformer'
_CN.batch_size = 1
_CN.surf_indices = [125]
_CN.FF_PANet_pretrian_path = r"../../checkpoint/FF_PANet/step_12000_final.pth"
# _CN.FF_PANet_pretrian_path = r"/home/haibo/FF_CompenUltra_lab/checkpoint/FF_PANet/step_12000_final.pth"
