...
local_surrogate_root="/e/Desktop/2026-camera-ready-setup-independent/SIComp_Benchmark/Surrogate_datasets"
local_real_root="/e/Desktop/2026-camera-ready-setup-independent/SIComp_Benchmark/Real_datasets"
data_names=("color_1" "color_2" "love_1" "love_2" "paint_1" "paint_2" "wood_1" "wood_2")
export DATASET_ROOT="$local_surrogate_root"

cd /h/home/lihaibo/Tutor_file/SIComp/src/python/ || exit
#for data_name in "${data_names[@]}"; do
#    echo "▶️ Starting compensation generation"
#    start_time=$SECONDS
...
#    echo "⏱️ Current run time: $((item_duration / 60)) min $((item_duration % 60)) sec"
...
#export DATASET_ROOT="$local_real_root"
#python calculate_real_compensation_metrics.py

total_duration=$SECONDS
echo "================================================"
echo "🎉 Done!"
echo "⏱️ Total runtime: $((total_duration / 3600)) h $(((total_duration % 3600) / 60)) min $((total_duration % 60)) sec"
